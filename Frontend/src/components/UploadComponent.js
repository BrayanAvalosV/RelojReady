        ...
        fetch('http://localhost:5000/upload-reloj', {
            ...
            .then(data => {
                if (data.error) {
                    ...
                    return fetch('http://localhost:5020/data', { method: 'GET' });
                }
            })
            .then(response => {
                if (!response.ok) {
            ...
            .then(data => {
                ...
                return fetch('http://localhost:5020/process_data', { method: 'GET' });
            })
            .then(response => {
                if (!response.ok) {
                    throw new Error('Error al llamar la API /adjust-time/process_data');
                }
